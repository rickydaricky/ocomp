...
class Database():
    ...
    async def compare(self, guild_id, player_1, player_2, hero):
        """Compares 2 players's overbuff stats on a particular hero"""
        response = ''

        p1_data = await Database.find_hero_data(self, guild_id, player_1, hero)
        p2_data = await Database.find_hero_data(self, guild_id, player_2, hero)
