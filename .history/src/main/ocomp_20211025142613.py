    ...
    async def on_message(self, message):
        ...
        if tokens[0].startswith('.help'):
            await message.channel.send(f'{message.author.mention}, '
                                       ...
                                       f'.addme [BattleTag] :: adds your BattleTag to my memory!\n'
                                       f'.hero [hero_name] :: displays your competitive stats on a partiular hero\n'
                                       f'.compare [discord_user_1] [discord_user_2] [hero_name] '
                                       ':: compares two players\'s stats on a particular hero')
